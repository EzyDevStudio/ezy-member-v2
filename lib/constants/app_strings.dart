...
class AppStrings {
  ...
  static List<CategoryModel> categories = [
    CategoryModel(
      ...
      icon: "assets/icons/ic_groceries.png",
      image: "assets/images/cat_groceries.png",
    ),
    CategoryModel(
      title: "Retail / Products",
      description: "Clothing & Fashion, Shoes & Accessories, Bags & Watches, Toys & Gifts",
      icon: "assets/icons/ic_fashion.png",
    ...
    CategoryModel(
      ...
      icon: "assets/icons/ic_electronics.png",
    ...
    CategoryModel(
      ...
      icon: "assets/icons/ic_health.png",
    ...
    CategoryModel(
      ...
      icon: "assets/icons/ic_agriculture.png",
    ...
    CategoryModel(
      ...
      icon: "assets/icons/ic_automotive.png",
    ...
    CategoryModel(
      ...
      icon: "assets/icons/ic_others.png",
