...
class _CustomLoadingState extends State<CustomLoading> with SingleTickerProviderStateMixin {
  ...
  void _createAnimations() {
    final length = widget.label.length;
    ...
    _animations = List.generate(length, (index) {
      ...
      return TweenSequence([
        TweenSequenceItem(tween: Tween(begin: 0.0, end: -15.0).chain(CurveTween(curve: Curves.easeOut)), weight: 50.0),
        TweenSequenceItem(tween: Tween(begin: -15.0, end: 0.0).chain(CurveTween(curve: Curves.easeIn)), weight: 50.0),
      ]).animate(
        CurvedAnimation(
          parent: _controller,
  ...
  Widget build(BuildContext context) => Center(
    child: Column(
      ...
      spacing: 32.dp,
      children: <Widget>[
        Image.asset("assets/images/launcher.png", height: 75.0),
        Row(
          ...
          children: List.generate(
            ...
            (index) => AnimatedBuilder(
              ...
              child: CustomText(widget.label[index], color: Colors.white, fontSize: 24.0, fontWeight: FontWeight.bold, maxLines: null),
            ),
          ),
        ),
      ],
